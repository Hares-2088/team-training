                ...
                <div className="relative group">
                    ...
                    <Card className="relative border-0 bg-slate-900/80 backdrop-blur-xl shadow-2xl">
                        <CardHeader className="space-y-3">
                            <CardTitle className="text-3xl bg-gradient-to-r from-white to-slate-200 bg-clip-text text-transparent">Welcome Back</CardTitle>
                            <CardDescription className="text-slate-400">Sign in to your FiT Team account</CardDescription>
                        </CardHeader>
                        <CardContent>
                            {error && (
