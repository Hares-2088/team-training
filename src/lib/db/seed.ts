...
async function seed() {
    try {
            ...
            exercises: [
                {
                    ...
                    sets: 4,
                    reps: '6-8',
                    notes: 'Deep squat, control the descent',
                },
                {
                    name: 'Deadlifts',
                    sets: 3,
        ...
        console.log(`  - ${training1.title} (Tomorrow)`);
        console.log(`  - ${training2.title} (Next Week)`);
        console.log(`  - ${pastTraining.title} (Completed)`);
